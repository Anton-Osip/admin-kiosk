...
const Loader = (
  ...
  return (
    <svg
      ...
      className="loader_loader__h6F1S"
      width="100%"
      height="100%"
      viewBox="0 0 391 391"
      fill="none"
      ...
      <style>
        {`
          ...
          .loader_f__enl_E {
            ...
            transform-origin: 195.5px 195.5px;
          }
          .loader_e__CpZcg {
            animation: rotate-counterclockwise 3.5s linear infinite;
            transform-origin: 195.5px 195.5px;
          }
          .loader_d__KT8Dc {
          ...
          .loader_c__ASZgP {
            animation: rotate-counterclockwise 4.5s linear infinite;
            transform-origin: 195.5px 195.5px;
          }
          .loader_b__a0zFl {
          ...
          .loader_a__0Pgl2 {
            animation: rotate-counterclockwise 5.5s linear infinite;
            transform-origin: 195.5px 195.5px;
          }
        `}
      </style>
      <g>
        <g filter="url(#filter0_i)"></g>
        ...
        <g className="loader_e__CpZcg" filter="url(#filter3_i)">
          <path
        ...
        <g className="loader_d__KT8Dc" filter="url(#filter4_i)">
          <path
        ...
        <g className="loader_c__ASZgP" filter="url(#filter5_i)">
          <path
